...
public class DBHelper {
    ...
    static Properties props = new Properties(); //Хранение загруженных настроек

    //Загрузка настроек из файла app.props в props
    static  {
    ...
    String appPORT = props.getProperty("appPORT");
